  ...
  <uni-transition ref="ani" custom-class="transition" mode-class="fade" :show="show">
    <view class="activityDetail">
      <view class="background">
        <image mode="widthFix" src="@/subPackagesB/static/vote/top-bg.png" class="bg"></image>
        <image mode="widthFix" src="@/subPackagesB/static/vote/bg.png" class="bg"></image>
      </view>
      <view class="content">
        <image :src="activityStatistics.voteCoverImg" class="banner"></image>
        <image mode="widthFix" src="@/subPackagesB/static/vote/logo-icon.png" class="logo"></image>
        ...
        <view class="statistic-wrap">
          <view class="item-wrap">
            ...
            <image mode="widthFix" src="@/subPackagesB/static/vote/data-bg.png" class="img"></image>
          </view>
          <view class="item-wrap">
        ...
        <image
          mode="scaleToFill"
          src="@/subPackagesB/static/vote/splitLine.png"
          class="split-line"
        ></image>
        <view class="logo-wrap">
          <image src="@/subPackagesB/static/vote/element1.png" class="element"></image>
          <text class="text">距离投票结束</text>
          <image src="@/subPackagesB/static/vote/element2.png" class="element"></image>
        </view>
      ...
      <view class="left">
        <view class="item-wrap">
          <view class="icon-text">
            <image
              mode="widthFix"
              src="@/subPackagesB/static/vote/activityIcon.png"
              class="icon"
            ></image>
          ...
          <view class="icon-text rank" @click="changePage">
            <image
              mode="widthFix"
              src="@/subPackagesB/static/vote/rankIconGray.png"
              class="icon"
            ></image>
