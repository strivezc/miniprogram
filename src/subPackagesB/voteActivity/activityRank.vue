  ...
  <uni-transition ref="ani" custom-class="transition" mode-class="fade" :show="show">
    <view class="activityRank">
      <view class="background">
        <image mode="widthFix" src="@/subPackagesB/static/vote/rankBg.png" class="bg"></image>
      ...
      <view class="left">
        <view class="item-wrap">
          <view class="icon-text" @click="changePage">
            <image
              mode="widthFix"
              src="@/subPackagesB/static/vote/activityIconGray.png"
              class="icon"
            ></image>
          ...
          <view class="icon-text rank">
            <image
              mode="widthFix"
              src="@/subPackagesB/static/vote/rankIcon.png"
              class="icon"
            ></image>
