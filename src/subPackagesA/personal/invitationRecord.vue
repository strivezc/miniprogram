<template>
  ...
  >
    <view class="li" v-for="(item, index) in list" :key="index">
      ...
      <view class="text-wrap">
        <view class="left">邀请来源：</view>
        <view class="right blue">
          <text v-if="item.inviteSource===0">邀请有礼</text>
          <text v-else-if="item.inviteSource===1">抽奖邀新</text>
          <text v-else-if="item.inviteSource===2">阶梯式邀新</text>
        </view>
      </view>
    </view>
