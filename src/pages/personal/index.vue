  ...
  export default {
    ...
    methods: {
      ...
      async navigateTo(url) {
        uni.navigateTo({ url });
        // if (url === '/subPackagesA/personal/invitationGift') {
        //   try {
        //     await UserService.activityShareImageUrl();
        //     uni.navigateTo({ url });
        //   } catch (e) {
        //     if (e.resultCode === -1) {
        //       this.resetToken().then(() => {
        //         uni.navigateTo({
        //           url: '/subPackagesA/personal/chooseLoginType?redirect=/subPackagesA/personal/invitationGift',
        //         });
        //       });
        //     } else {
        //       uni.showToast({
